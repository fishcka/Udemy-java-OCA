...
//цей файл має запускатись через Command Line

public class UpdatedArray_zaur {
    ...
    public static void main(String[] args) {
        ...
        for (String s : args) {
            for (int i = 0; i < target.length; i++) {
                if (s.equals(target[i])) { //якщо написати навпаки то вийде NullPointerException, як у мене
                    target[i] = null;
                }
            }
        }
